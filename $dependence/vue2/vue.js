...
;(function (global, factory) {
	...
	Dep.prototype.depend = function depend(key) {
		if (Dep.target) {
	...
	function mountComponent(vm, el, hydrating) {
		...
		new Watcher(vm, updateComponent, noop, null, true /* isRenderWatcher */, 'mountComponent')
		hydrating = false
	 ...
	 */
	var Watcher = function Watcher(vm, expOrFn, cb, options, isRenderWatcher, __keyName = '') {
		this.vm = vm
		this.__keyName = __keyName + '' + uid$1
		if (isRenderWatcher) {
			vm._watcher = this
		}
	...
	function initComputed(vm, computed) {
		...
		for (var key in computed) {
			...
			if (!isSSR) {
				...
				watchers[key] = new Watcher(vm, getter || noop, noop, computedWatcherOptions, false, key)
			}
