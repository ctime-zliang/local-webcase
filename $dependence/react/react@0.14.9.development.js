	...
	return (function e(t, n, r) {
	...
	})(
		{
			...
			3: [
				function (_dereq_, module, exports) {
					...
					var useFallbackCompositionData =
						ExecutionEnvironment.canUseDOM && (!canUseCompositionEvent || (documentMode && documentMode > 8 && documentMode <= 11))
			...
			7: [
				...
				{ 114: 114, 119: 119, 120: 120, 130: 130, 148: 148, 15: 15, 16: 16, 19: 19, 83: 83, 92: 92 },
			],
			8: [
				function (_dereq_, module, exports) {
					/**
						...
						injectDOMPropertyConfig: function (domPropertyConfig) {
							...
							for (var propName in Properties) {
								...
								!(!propertyInfo.mustUseAttribute || !propertyInfo.mustUseProperty)
									? 'development' !== 'production'
										? invariant(false, 'DOMProperty: Cannot require using both attribute and property: %s', propName)
										: invariant(false)
									: undefined
								!(propertyInfo.mustUseProperty || !propertyInfo.hasSideEffects)
									? 'development' !== 'production'
										? invariant(false, 'DOMProperty: Properties that have side effects must use property: %s', propName)
										: invariant(false)
									: undefined
					...
					var Danger = {
						...
						dangerouslyRenderMarkup: function (markupList) {
							...
							for (var i = 0; i < markupList.length; i++) {
								!markupList[i]
									? 'development' !== 'production'
										? invariant(false, 'dangerouslyRenderMarkup(...): Missing markup.')
										: invariant(false)
									: undefined
								...
								for (var j = 0; j < renderNodes.length; ++j) {
									...
									if (renderNode.hasAttribute && renderNode.hasAttribute(RESULT_INDEX_ATTR)) {
										...
										!!resultList.hasOwnProperty(resultIndex)
											? 'development' !== 'production'
												? invariant(false, 'Danger: Assigning to an already-occupied result index.')
												: invariant(false)
											: undefined
							...
							!(resultListAssignmentCount === resultList.length)
								? 'development' !== 'production'
									? invariant(false, 'Danger: Did not assign to every index of resultList.')
									: invariant(false)
								: undefined
				...
				function (_dereq_, module, exports) {
					...
					function accumulateTwoPhaseDispatchesSingle(event) {
						if (event && event.dispatchConfig.phasedRegistrationNames) {
							EventPluginHub.injection
								.getInstanceHandle()
								.traverseTwoPhase(event.dispatchMarker, accumulateDirectionalDispatches, event)
						}
					}
					...
					function accumulateTwoPhaseDispatchesSingleSkipTarget(event) {
						if (event && event.dispatchConfig.phasedRegistrationNames) {
							EventPluginHub.injection
								.getInstanceHandle()
								.traverseTwoPhaseSkipTarget(event.dispatchMarker, accumulateDirectionalDispatches, event)
						}
					}
			...
			29: [
				...
				{ 137: 137, 144: 144, 147: 147, 148: 148, 155: 155, 23: 23, 30: 30, 52: 52, 69: 69, 72: 72, 73: 73 },
			],
			30: [
				function (_dereq_, module, exports) {
					/**
			...
			33: [
					...
					var ReactCompositeComponentMixin = {
						...
						mountComponent: function (rootID, transaction, context) {
							...
							if ('development' !== 'production') {
								...
								'development' !== 'production'
									? warning(
											!inst.getInitialState || inst.getInitialState.isReactClassApproved,
						...
						getName: function () {
							...
							return (
								type.displayName || (constructor && constructor.displayName) || type.name || (constructor && constructor.name) || null
							)
						},
				...
				{ 126: 126, 137: 137, 144: 144, 155: 155, 23: 23, 32: 32, 34: 34, 52: 52, 62: 62, 71: 71, 72: 72, 73: 73, 76: 76, 82: 82 },
			],
			34: [
				function (_dereq_, module, exports) {
					/**
			...
			35: [
				...
				{ 108: 108, 123: 123, 130: 130, 155: 155, 34: 34, 46: 46, 49: 49, 61: 61, 65: 65, 71: 71, 76: 76, 83: 83, 84: 84 },
			],
			36: [
				function (_dereq_, module, exports) {
					/**
								...
								for (var event in mediaEvents) {
									if (mediaEvents.hasOwnProperty(event)) {
										inst._wrapperState.listeners.push(
											ReactBrowserEventEmitter.trapBubbledEvent(EventConstants.topLevelTypes[event], mediaEvents[event], node)
										)
									}
								}
					...
					var ReactDOMIDOperations = {
						...
						updatePropertyByID: function (id, name, value) {
							...
							!!INVALID_PROPERTY_ERRORS.hasOwnProperty(name)
								? 'development' !== 'production'
									? invariant(false, 'updatePropertyByID(...): %s', INVALID_PROPERTY_ERRORS[name])
									: invariant(false)
								: undefined
					...
					function _handleChange(event) {
						...
						if (props.type === 'radio' && name != null) {
							...
							for (var i = 0; i < group.length; i++) {
								...
								!otherInstance
									? 'development' !== 'production'
										? invariant(false, 'ReactDOMInput: Unknown radio button ID %s.', otherID)
										: invariant(false)
									: undefined
						...
						measure: function (moduleName, fnName, func) {
							return function () {
								...
								if (fnName === '_renderNewRootComponent' || fnName === 'flushBatchedUpdates') {
									...
									ReactDefaultPerf._allMeasurements[ReactDefaultPerf._allMeasurements.length - 1].totalTime =
				...
				function (_dereq_, module, exports) {
					...
					var ReactInputSelection = {
						hasSelectionCapabilities: function (elem) {
							...
							return (
								nodeName &&
								((nodeName === 'input' && elem.type === 'text') || nodeName === 'textarea' || elem.contentEditable === 'true')
							)
						},
				...
				function (_dereq_, module, exports) {
					...
					function getNextDescendantID(ancestorID, destinationID) {
						!(isValidID(ancestorID) && isValidID(destinationID))
							? 'development' !== 'production'
								? invariant(false, 'getNextDescendantID(%s, %s): Received an invalid React DOM ID.', ancestorID, destinationID)
								: invariant(false)
							: undefined
					...
					function traverseParentPath(start, stop, cb, arg, skipFirst, skipLast) {
						...
						!(start !== stop)
							? 'development' !== 'production'
								? invariant(false, 'traverseParentPath(...): Cannot traverse from and to the same ID, `%s`.', start)
								: invariant(false)
							: undefined
						...
						if (id) {
							if (nodeCache.hasOwnProperty(id)) {
								...
								if (cached !== node) {
									!!isValid(cached, id)
										? 'development' !== 'production'
											? invariant(false, 'ReactMount: Two valid but unequal nodes with the same `%s`: %s', ATTR_NAME, id)
											: invariant(false)
										: undefined
					...
					function isValid(node, id) {
						if (node) {
							!(internalGetID(node) === id)
								? 'development' !== 'production'
									? invariant(false, 'ReactMount: Unexpected modification of `%s`', ATTR_NAME)
									: invariant(false)
								: undefined
					...
					function createUnionTypeChecker(arrayOfTypeCheckers) {
						...
						function validate(props, propName, componentName, location, propFullName) {
							for (var i = 0; i < arrayOfTypeCheckers.length; i++) {
								...
								if (
									checker(props, propName, componentName, location, propFullName, 'SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED') ==
									null
								) {
									return null
								}
				...
				function (_dereq_, module, exports) {
					...
					function onlyChild(children) {
						!ReactElement.isValidElement(children)
							? 'development' !== 'production'
								? invariant(false, 'onlyChild must be passed a children with exactly one child.')
								: invariant(false)
							: undefined
						return children
					}
