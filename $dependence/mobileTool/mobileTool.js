...
function checkKey(iKey){
  if(iKey==32||iKey==229){/*空格和异常*/
    return true;
  }
  if(iKey>47&&iKey<58){/*数字*/
    return true;
  }
  if(iKey>64&&iKey<91){/*字母*/
    return true;
  }
  if(iKey>95&&iKey<108){/*数字键盘1*/
    return true;
  }
  if(iKey>108&&iKey<112){/*数字键盘2*/
    return true;
  }
  if(iKey>185&&iKey<193){/*符号1*/
    return true;
  }
  if(iKey>218&&iKey<223){/*符号2*/
    return true;
  }
  return false;
}
