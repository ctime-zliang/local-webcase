...
!(function (t) {
	...
	;(r.prototype.cache = n),
		...
		(r.prototype.use = function (t, r, l, c) {
			...
			function p() {
				l.push(layui[v]),
					t.length > 1
						...
						: 'function' == typeof r &&
						  (function () {
								return layui.jquery && 'function' == typeof layui.jquery && 'define' !== c
			...
			if (((m = m.replace(/^\{\/\}/, '')), !n.modules[v] && layui[v] && (n.modules[v] = m), n.modules[v]))
				!(function b() {
					return ++h > (1e3 * n.timeout) / 4
						? a(v + ' is not a valid module', 'error')
						: void ('string' == typeof n.modules[v] && n.status[v] ? p() : setTimeout(b, 4))
				})()
			else {
				...
				;(g.async = !0),
					...
					d.appendChild(g),
					!g.attachEvent || (g.attachEvent.toString && g.attachEvent.toString().indexOf('[native code') < 0) || i
						? g.addEventListener(
								'load',
								function (t) {
									s(t, m)
				...
				'function' != typeof r
					...
					: ((function f() {
							return ++p > (1e3 * n.timeout) / 100
								? a(t + ' timeout')
								: void (1989 === parseInt(i.getStyle(e.getElementById(s), 'width'))
										? (function () {
												r()
										  })()
										: setTimeout(f, 100))
		...
		(n.link = function (t, r, o) {
			...
			;(c.rel = 'stylesheet'),
				...
				'function' == typeof r &&
					!(function l() {
						return ++s > 80
							? window.console && console.error(u + '.css: Invalid')
							: void (1989 === parseInt(n.getStyle(e.getElementById(a), 'width')) ? r() : setTimeout(l, 100))
					})()
		}),
		...
		(n.position = function (t, r, o) {
			if (r) {
				...
				f + c + l > s('width') && (f = s('width') - c - l),
					h + u + l > s() &&
						(i.top > u + l ? (h = i.top - u - 2 * l) : 'right' === o.clickType && ((h = s() - u - 2 * l), h < 0 && (h = 0)))
				var p = o.position
				if (
						...
						var i = Math.floor((t - 1) / 2),
							...
							u =
								n > 1
									...
									: t
						for (
							u - r < t - 1 && (r = u - t + 1), a.first !== !1 && r > 2 && e.push('<span class="layui-laypage-spr">&#x2026;</span>');
							r <= u;
							r++
						)
							r === a.curr
	...
	;(v.isLeapYear = function (e) {
		...
		(v.prototype.init = function () {
			...
			;(a.elem = lay(a.elem)),
				...
				a.elem[0] &&
					(a.range === !0 && (a.range = '-'),
					i[a.type] ||
						(e.console && console.error && console.error("laydate type error:'" + a.type + "' is not supported"), (a.type = 'date')),
					...
					lay.each(t.format, function (e, a) {
						var l = new RegExp(n).test(a)
							? '\\d{' +
							  (function () {
									return new RegExp(n).test(t.format[0 === e ? e + 1 : e - 1] || '')
										? /^yyyy|y$/.test(a)
											? 4
											: a.length
										: /^yyyy$/.test(a)
					...
					a.elem.attr('lay-key') || (a.elem.attr('lay-key', t.index), a.eventElem.attr('lay-key', t.index)),
					(a.mark = lay.extend(
						{},
			...
			if (
				...
				lay.each(new Array(2), function (e) {
					...
					lay.each(l, function (e, t) {
						...
						y.appendChild(d),
						(i[e] = lay.elem('div', { class: 'layui-laydate-main laydate-main-list-' + e })),
						i[e].appendChild(n),
						i[e].appendChild(y),
						r.push(l),
						o.push(y),
				...
				lay(y).html(
					(function () {
						var e = [],
							l = []
						return (
							'datetime' === t.type && e.push('<span lay-type="datetime" class="laydate-btns-time">' + a.timeTips + '</span>'),
							lay.each(t.btns, function (e, i) {
								var r = a.tools[i] || 'btn'
								;(t.range && 'now' === i) ||
									(n && 'clear' === i && (r = 'cn' === t.lang ? '重置' : 'Reset'),
				...
				var m = lay.elem('style'),
					c = ['#{{id}} .layui-laydate-header{background-color:{{theme}};}', '#{{id}} .layui-this{background-color:{{theme}} !important;}']
						.join('')
						.replace(/{{id}}/g, e.elemID)
						.replace(/{{theme}}/g, t.theme)
				'styleSheet' in m ? (m.setAttribute('type', 'text/css'), (m.styleSheet.cssText = c)) : (m.innerHTML = c),
					lay(l).addClass('laydate-theme-molv'),
					l.appendChild(m)
			}
			e.remove(v.thisElemDate),
				n ? t.elem.append(l) : (document.body.appendChild(l), e.position()),
				e.checkDate().calendar(null, 0, 'init'),
				e.changeEvent(),
				(v.thisElemDate = e.elemID),
				'function' == typeof t.ready && t.ready(lay.extend({}, t.dateTime, { month: t.dateTime.month + 1 }))
		}),
					...
					;(t = (t.match(l.EXP_SPLIT) || []).slice(1)),
						...
						lay.each(l.format, function (o, s) {
							...
							t[o].length < s.length && (a = !0),
								/yyyy|y/.test(s)
									? (d < y[0] && ((d = y[0]), (a = !0)), (e.year = d))
									: /MM|M/.test(s)
									? (d < 1 && ((d = 1), (a = !0)), (e.month = d - 1))
									: /dd|d/.test(s)
									? (d < 1 && ((d = 1), (a = !0)), (e.date = d))
									: /HH|H/.test(s)
									? (d < 1 && ((d = 0), (a = !0)), (e.hours = d), i.range && (l[r[n]].hours = d))
									: /mm|m/.test(s)
									? (d < 1 && ((d = 0), (a = !0)), (e.minutes = d), i.range && (l[r[n]].minutes = d))
									: /ss|s/.test(s) && (d < 1 && ((d = 0), (a = !0)), (e.seconds = d), i.range && (l[r[n]].seconds = d))
						}),
						m(e)
				}
			return 'limit' === e
				  ...
				  'string' == typeof d && d
						? l.EXP_IF.test(d)
							? i.range
								...
								: c(o, d)
							: (l.hint(r.formatError[0] + (i.range ? i.format + ' ' + i.range + ' ' + i.format : i.format) + r.formatError[1]),
							  (a = !0))
						: d && d.constructor === Date
						? (i.dateTime = l.systemDate(d))
						: ((i.dateTime = l.systemDate()), delete l.startTime, delete l.endTime),
				  m(o),
			...
			return (
				...
				lay.each(p, function (e, t) {
					...
					;(t = lay(t)),
						t.removeAttr('class'),
						e < l
							? ((n = i - l + e), t.addClass('laydate-day-prev'), (a = s.getAsYM(m.year, m.month, 'sub')))
							: e >= l && e < r + l
							? ((n = e - l), n + 1 === m.date && t.addClass(o))
							: ((n = e - r - l), t.addClass('laydate-day-next'), (a = s.getAsYM(m.year, m.month))),
						a[1]++,
						(a[2] = n + 1),
						t.attr('lay-ymd', a.join('-')).html(a[2]),
						s.mark(t, a).limit(t, { year: a[0], month: a[1] - 1, date: a[2] }, e)
				}),
				...
				'cn' === d.lang
					? (lay(g[0])
					  ...
					  lay(g[1])
							.attr('lay-type', 'month')
							.html(m.month + 1 + '月'))
					: (lay(g[0]).attr('lay-type', 'month').html(u.month[m.month]), lay(g[1]).attr('lay-type', 'year').html(m.year)),
				h &&
					(d.range
						? e &&
						  ((s.listYM = [
						  ...
						  'time' === d.type
								? s.setBtnStatus('时间', lay.extend({}, s.systemDate(), s.startTime), lay.extend({}, s.systemDate(), s.endTime))
								: s.setBtnStatus(!0))
						: ((s.listYM = [[m.year, m.month + 1]]), s.list(d.type, 0))),
		...
		(v.prototype.list = function (e, t) {
			var a = this,
				...
				y = lay.elem('ul', { class: m + ' ' + { year: 'laydate-year-list', month: 'laydate-month-list', time: 'laydate-time-list' }[e] }),
				d = a.elemHeader[t],
				c = lay(d[2]).find('span'),
				u = a.elemCont[t || 0],
				h = lay(u).find('.' + m)[0],
			...
			if ((D[0] < 1 && (D[0] = 1), 'year' === e)) {
				...
				w < 1 && (w = C = 1),
					lay.each(new Array(15), function (e) {
						...
						C == D[0] && lay(l).addClass(o),
							...
							y.appendChild(l),
							C < a.firstDate.year
								? ((i.month = n.min.month), (i.date = n.min.date))
								: C >= a.firstDate.year && ((i.month = n.max.month), (i.date = n.max.date)),
							a.limit(lay(l), i, t),
							C++
					}),
					lay(c[v ? 0 : 1])
						...
						.each(function (e, n) {
							lay(n)
								...
								.each(function (n, l) {
									a.limit(
										lay(l),
										[{ hours: n }, { hours: a[x].hours, minutes: n }, { hours: a[x].hours, minutes: a[x].minutes, seconds: n }][
											e
										],
										t,
				...
				n.range ? a[x] || (a[x] = { hours: 0, minutes: 0, seconds: 0 }) : (a[x] = l),
			...
			if ((h && u.removeChild(h), u.appendChild(y), 'year' === e || 'month' === e))
							...
							if (!lay(this).hasClass(s)) {
								...
								d
									? (lay(y)
									  ...
									  'month' === n.type &&
											'year' === e &&
											((a.listYM[t][0] = i), r && (t ? (l.year = i) : (a.endDate.year = i)), a.list('month', t)))
									: (a.checkDate('limit').calendar(null, t), a.closeList()),
									a.setBtnStatus(),
									n.range ||
										((('month' === n.type && 'month' === e) || ('year' === n.type && 'year' === e)) &&
			...
			return (
				lay.each(i, function (e, t) {
					;/yyyy|y/.test(t)
						...
						: /ss|s/.test(t) && (i[e] = lay.digit(l.seconds, t.length))
				}),
		...
		(v.prototype.tool = function (e, t) {
			var a = this,
				...
				o = {
					datetime: function () {
						lay(e).hasClass(s) ||
							(a.list('time', 0), n.range && a.list('time', 1), lay(e).attr('lay-type', 'date').html(a.lang().dateTips))
					},
					date: function () {
					...
					clear: function () {
						a.setValue('').remove(),
							...
							n.range && (delete a.endDate, delete a.startTime, delete a.endTime),
							a.done(['', {}, {}])
					},
					now: function () {
						var e = new Date()
						lay.extend(i, a.systemDate(), { hours: e.getHours(), minutes: e.getMinutes(), seconds: e.getSeconds() }),
		...
		(v.prototype.change = function (e) {
				...
				o = function (o) {
					...
					return (
						...
						(s || y) &&
							...
							a.range || t.limit(lay(t.footer).find(f), { year: r[0] })),
						t.setBtnStatus(),
						s || y
					)
				}
			return {
				...
				prevMonth: function () {
					...
					lay.extend(n, { year: l[0], month: l[1] }), t.checkDate('limit').calendar(null, e), a.range || t.done(null, 'change')
				},
				nextMonth: function () {
				...
				lay(document)
					...
					.on('keydown', function (e) {
						13 === e.keyCode &&
							...
							(e.preventDefault(), lay(t.footer).find(f)[0].click())
					}),
			...
			if (((a = e[x]), a || 0 === a))
				if ('object' === pe.type(a)) pe.merge(v, a.nodeType ? [a] : a)
					...
					if ((!fe.leadingWhitespace && $e.test(a) && v.push(t.createTextNode($e.exec(a)[0])), !fe.tbody))
						for (
							a = 'table' !== l || Ve.test(a) ? ('<table>' !== f[1] || Ve.test(a) ? 0 : u) : u.firstChild, o = a && a.childNodes.length;
							o--;
	...
	function k(e, t) {
		...
		if (1 === t.nodeType) {
			...
			'script' === n && t.text !== e.text
				? ((C(t).text = e.text), E(t))
				: 'object' === n
				? (t.parentNode && (t.outerHTML = e.outerHTML), fe.html5Clone && e.innerHTML && !pe.trim(t.innerHTML) && (t.innerHTML = e.innerHTML))
		...
		for (var o = n === (r ? 'border' : 'content') ? 4 : 'width' === t ? 1 : 0, a = 0; o < 4; o += 2)
			'margin' === n && (a += pe.css(e, n + Oe[o], !0, i)),
				r
					...
					: ((a += pe.css(e, 'padding' + Oe[o], !0, i)), 'padding' !== n && (a += pe.css(e, 'border' + Oe[o] + 'Width', !0, i)))
		return a
	}
	function M(e, t, n) {
		var r = !0,
	...
	function $(e, t, n) {
		var r,
			...
			u = function () {
				if (i) return !1
				for (
					var t = Nt || R(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length;
					a < u;
					a++
				)
					l.tweens[a].run(o)
					...
					return r !== H && 9 === r.nodeType && r.documentElement
						? ((H = r),
						  ...
						  (w.qsa = me.test(H.querySelectorAll)) &&
								(i(function (e) {
									;(q.appendChild(e).innerHTML =
										"<a id='" + P + "'></a><select id='" + P + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
						  ...
						  (w.matchesSelector = me.test(
								(O = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector)
						  )) &&
								i(function (e) {
			...
			return this instanceof pe.Event
				? (e && e.type
						? ((this.originalEvent = e),
						  (this.type = e.type),
						  (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && e.returnValue === !1) ? v : x))
						: (this.type = e),
				  t && pe.extend(this, t),
	...
	;(pe.Animation = pe.extend($, {
		...
		(pe.speed = function (e, t, n) {
			var r =
				e && 'object' == typeof e
					? pe.extend({}, e)
					: { complete: n || (!n && t) || (pe.isFunction(e) && e), duration: e, easing: (n && t) || (t && !pe.isFunction(t) && t) }
			return (
			...
			attr: function (e, t, n) {
				...
				if (3 !== o && 8 !== o && 2 !== o)
					return 'undefined' == typeof e.getAttribute
						? pe.prop(e, t, n)
						: ((1 === o && pe.isXMLDoc(e)) || ((t = t.toLowerCase()), (i = pe.attrHooks[t] || (pe.expr.match.bool.test(t) ? Ht : Lt))),
						  void 0 !== n
								? null === n
			...
			timeAgo: function (e, t) {
				...
				return n > 26784e5
					? ((n = new Date(e)),
					  ...
					  t || ((a[1][0] = i.digit(n.getHours())), (a[1][1] = i.digit(n.getMinutes())), (a[1][2] = i.digit(n.getSeconds()))),
					  a[0].join('-') + ' ' + a[1].join(':'))
					: n >= 864e5
					? ((n / 1e3 / 60 / 60 / 24) | 0) + '天前'
					: n >= 36e5
		...
		f = {
			tabClick: function (t, i, s, o) {
				...
				;('javascript:;' !== d.attr('href') && '_blank' === d.attr('target')) ||
					(r.addClass(l).siblings().removeClass(l), u.eq(i).addClass(n).siblings().removeClass(n)),
			...
			tabDelete: function (t, i) {
				...
				n.hasClass(l) && (n.next()[0] ? f.tabClick.call(n.next()[0], null, s + 1) : n.prev()[0] && f.tabClick.call(n.prev()[0], null, s - 1)),
					...
					layui.event.call(this, e, 'tabDelete(' + c + ')', { elem: o, index: s })
			},
			tabAuto: function () {
			...
			clickThis: function () {
				...
				;('javascript:;' !== t.attr('href') && '_blank' === t.attr('target')) || y || c[0] || (i.find('.' + l).removeClass(l), s.addClass(l)),
					i.hasClass(u) &&
						(c.removeClass(h),
						c[0] &&
							(s['none' === c.css('display') ? 'addClass' : 'removeClass'](r + 'ed'),
					...
					var t = 200,
						...
						b = function (l, o, r) {
							var c = a(this),
								f = c.find('.' + d)
							o.hasClass(u)
								? l.css({ top: c.position().top, height: c.children('a').outerHeight(), opacity: 1 })
								: (f.addClass(h),
								  l.css({
	...
	;(p.prototype.config = {
		...
		(p.prototype.file = function () {
			var e = this,
				...
				n = (e.elemFile = t(
					[
						'<input class="' + u + '" type="file" accept="' + i.acceptMime + '" name="' + i.field + '"',
						i.multiple ? ' multiple' : '',
						'>',
					].join('')
				)),
...
layui.define(['jquery', 'laytpl', 'lay'], function (e) {
	...
	;(k.prototype.config = {
							...
							var r = l.child && l.child.length > 0,
								...
								d = (function () {
									return (
										...
										l.type ? { group: 'group', parent: 'parent', '-': '-' }[l.type] || 'parent' : ''
									)
								})()
							if ('-' === d || l.title || l.id || r) {
								var s = i(
											...
											(function () {
												var e = {
													group:
														...
														(a.isAllowSpread ? (o ? ' layui-menu-item-down' : ' layui-menu-item-up') : ''),
													parent: f,
		...
		(k.prototype.position = function (e) {
			var i = this,
				n = i.config
			lay.position(n.elem[0], i.elemView[0], { position: n.position, e: i.e, clickType: 'contextmenu' === n.trigger ? 'right' : null })
		}),
		...
		(d.spread = function (e) {
			...
			e.hasClass(m)
				? (e.removeClass(m).addClass(c), i.removeClass('layui-icon-down').addClass('layui-icon-up'))
				: (e.removeClass(c).addClass(m), i.removeClass('layui-icon-up').addClass('layui-icon-down'))
		}),
		!(function () {
			var e = i(window),
				n = i(document)
					...
					[
						...
						'style="' +
							(function () {
								...
								return o.color
									? ((e = o.color),
									  (o.color.match(/[0-9]{1,3}/g) || []).length > 3 &&
											((o.alpha && 'rgb' == o.format) || (e = '#' + C(k(P(o.color))))),
									  'background: ' + e)
									: e
							})() +
							'">',
										...
										e.push(
											[
												'<div class="layui-colorpicker-pre' +
													((o.match(/[0-9]{1,3}/g) || []).length > 3 ? ' layui-colorpicker-pre-isalpha' : '') +
													'">',
						...
						if (l.indexOf(',') > -1) {
							...
							(f = y(l)),
								...
								e.elemColorBox
									...
									.addClass(a)
						return 'change' === n
							? (e.select(f.h, f.s, f.b, n), void (o.change && o.change(c)))
							: ((e.color = l), o.done && o.done(l), void e.removePicker())
					},
				}
...
layui.define('layer', function (e) {
						...
						var e,
							...
							y = function (i, u, f) {
								...
								if (!u) {
														...
														l[0]
															? ((y = r[t]()),
															  (n[0] && !n.hasClass(c)) || !y[0]
																	? (n.addClass(s).siblings().removeClass(s), void T())
																	: i(t, y))
															: (y = null)
													)
												}
										...
										q = function (e) {
											...
											return (
												...
												($(
													...
													function (e) {
														e
															? g.find('.' + r)[0] || g.append('<p class="' + r + '">无匹配项</p>')
															: g.find('.' + r).remove()
													},
													'keyup'
												),
									...
									f &&
										k.on('keyup', q).on('blur', function (i) {
										...
										x.on('click', function () {
											...
											return (
												...
												layui.event.call(this, l, 'select(' + n + ')', { elem: p[0], value: a, othis: i }),
												w(!0),
												!1)
											)
										}),
											...
											return (
												layui.each(e, function (e, a) {
													0 !== e || a.value
														...
														: t.push('<dd lay-value="" class="layui-select-tips">' + (a.innerHTML || i) + '</dd>')
												}),
						...
						var e = {
							...
							a = function (e, i) {
								...
								e.on('click', function () {
									...
									a[0].disabled ||
										(a[0].checked
											? ((a[0].checked = !1), e.removeClass(i[1]).find('em').text(n[1]))
											: ((a[0].checked = !0), e.addClass(i[1]).find('em').text(n[0])),
										layui.event.call(a[0], l, i[2] + '(' + t + ')', { elem: a[0], value: a[0].value, othis: e }))
								})
							}
						i.each(function (i, n) {
							var l = t(this),
	...
	var d = function () {
			...
			return (
								...
								if (((f = f || a[l][1]), 'required' === l && (f = o.attr('lay-reqText') || f), c))
									return (
										'tips' === u
											? i.tips(
													...
													(function () {
														return 'string' == typeof o.attr('lay-ignore') ||
															('select' !== r.tagName.toLowerCase() && !/^checkbox|radio$/.test(r.type))
															? o
															: o.next()
													})(),
													{ tips: 1 }
											...
											: /\bstring|number\b/.test(typeof f) && i.msg(f, { icon: 5, shift: 6 }),
										n.android ||
											n.ios ||
											setTimeout(function () {
												r.focus()
				...
				!e && ((o = f.getValue(null, u)), layui.event.call(this, l, 'submit(' + h + ')', { elem: this, form: v, field: o }))
			)
		},
		f = new u(),
		v = t(document),
		...
		(b.prototype.spread = function (e, a) {
			...
			m.on('click', function (i) {
				...
				k.on('click', function () {
					var n = i(this)
					n.hasClass(d) ||
						((x = e.hasClass(C) ? (t.onlyIconControl ? 'open' : 'close') : t.onlyIconControl ? 'close' : 'open'),
	...
	;(I.prototype.config = {
		...
		(I.prototype.render = function () {
			...
			if (
				...
				(a.response = t.extend(
					{ statusName: 'code', statusCode: 0, msgName: 'msg', dataName: 'data', totalRowName: 'totalRow', countName: 'count' },
					a.response
				)),
				...
				return e
			a.height && /^full-\d+$/.test(a.height) && ((e.fullHeightGap = a.height.split('-')[1]), (a.height = j.height() - e.fullHeightGap)),
				e.setInit()
			var l = a.elem,
				n = l.next('.' + v),
				o = (e.elem = t(i(E).render({ VIEW_CLASS: v, data: a, index: e.index })))
			if (
				((a.index = e.index),
				(e.key = a.id || a.index),
				n[0] && n.remove(),
							...
							layui.each(a, function (l, n) {
								...
								if (((n.key = e + '-' + l), (n.hide = n.hide || !1), n.colGroup || n.colspan > 1)) {
									...
									layui.each(i.cols[e + 1], function (t, i) {
										i.HAS_PARENT ||
											(o > 1 && o == n.colspan) ||
											((i.HAS_PARENT = !0), (i.parentKey = e + '-' + l), (o += parseInt(i.colspan > 1 ? i.colspan : 1)))
									}),
										(n.colGroup = !0)
								}
								t.initOpts(n)
						...
						return d
							? void (
									...
									(e
										...
										: ((c = d.width || 0),
										  /\d+%$/.test(c)
												? ((c = Math.floor((parseFloat(c) / 100) * o)), c < s && (c = s))
												: c || ((d.width = c = 0), a++)),
									d.hide && (c = 0),
									(n += c))
							  )
						...
						success: function (t) {
							'function' == typeof a.parseData && (t = a.parseData(t) || t),
								t[n.statusName] != n.statusCode
									? (i.renderForm(),
									  i.errorView(
											t[n.msgName] || '返回的数据不符合规范，正确的成功状态码应为："' + n.statusName + '": ' + n.statusCode
									  ))
									: (i.renderData(t, e, t[n.countName]), o(), (a.time = new Date().getTime() - i.startTime + ' ms')),
								i.setColsWidth(),
										...
										if (((void 0 !== m && null !== m) || (m = ''), !r.colGroup)) {
											var g = [
												...
												'<div class="layui-table-cell laytable-cell-' +
													...
													'">' +
													(function () {
														var n = t.extend(!0, { LAY_INDEX: p }, l),
			...
			;(c.sortKey = { field: n, sort: i }),
				u.autoSort &&
					('asc' === i
						...
						: 'desc' === i
						? (r = layui.sort(f, n, !0))
						: ((r = layui.sort(f, d.config.indexName)), delete c.sortKey)),
				(s[u.response.dataName] = r || f),
				c.renderData(s, c.page, c.count, !0),
				l && layui.event.call(e, y, 'sort(' + h + ')', { field: n, type: i })
		}),
		(I.prototype.loading = function (e) {
			...
			a.loading &&
				(e
					? (i.layInit && i.layInit.remove(), delete i.layInit, i.layBox.find(b).remove())
					: ((i.layInit = t(
							[
		...
		(I.prototype.fullSize = function () {
			var e,
				...
				i = t.config,
				a = i.height
			t.fullHeightGap && ((a = j.height() - t.fullHeightGap), a < 135 && (a = 135), t.elem.css('height', a)),
				a &&
		...
		(I.prototype.events = function () {
			...
			i.layTool.on('click', '*[lay-event]', function (e) {
				...
				switch ((layui.stope(e), F.trigger('table.tool.panel.remove'), l.close(i.tipsIndex), c)) {
					...
					case 'LAYTABLE_EXPORT':
						r.ie
							? l.tips('导出功能不支持 IE，请用 Chrome 等高级浏览器导出', this, { tips: 3 })
							: s({
									list: (function () {
									...
									layui.each(e, function (e, t) {
										if (e in o) {
											...
											;(o[e] = t),
												...
												l.children(h).html(u({ templet: a }, t, o)),
												l.data('content', t)
										}
									})
							},
			...
			i.elem.on('click', 'input[name="layTableCheckbox"]+', function () {
				...
				o
					...
					layui.event.call(e[0], y, 'checkbox(' + p + ')', v.call(e[0], { checked: n, type: o ? 'all' : 'one' }))
			}),
				i.elem.on('click', 'input[lay-type="layTableRadio"]+', function () {
					...
					layui.each(n, function (e, t) {
						...
						layui.event.call(this, y, 'radio(' + p + ')', v.call(this, { checked: l }))
				}),
				i.layBody
						...
						if (i.colGroup) {
							...
							o++,
								...
								layui.each(a[e + 1], function (e, t) {
									t.PARENT_COL_INDEX ||
										(l > 1 && l == i.colspan) ||
										((t.PARENT_COL_INDEX = o), i.CHILD_COLS.push(t), (l += parseInt(t.colspan > 1 ? t.colspan : 1)))
								})
						}
...
layui.define('jquery', function (e) {
	...
	;(v.prototype.config = { length: 5, text: !1, readonly: !1, half: !1, value: 0, theme: '' }),
		(v.prototype.render = function () {
			var e = this,
				l = e.config,
			...
			;(l.elem = a(l.elem)),
				...
				parseInt(l.value) !== l.value && (l.half || (l.value = Math.ceil(l.value) - l.value < 0.5 ? Math.ceil(l.value) : Math.floor(l.value)))
			for (var n = '<ul class="layui-rate" ' + (l.readonly ? 'readonly' : '') + '>', s = 1; s <= l.length; s++) {
				...
				l.half && parseInt(l.value) !== l.value && s == Math.ceil(l.value)
					? (n = n + '<li><i class="layui-icon layui-icon-rate-half" ' + i + '></i></li>')
					: (n += r)
			}
