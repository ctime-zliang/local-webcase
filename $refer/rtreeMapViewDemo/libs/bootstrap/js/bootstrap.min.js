			...
			backdrop: function (b) {
				...
				if (this.isShown && this.options.backdrop) {
					...
					;(this.$backdrop = a('<div class="modal-backdrop ' + d + '" />').appendTo(document.body)),
						this.$backdrop.click(
							this.options.backdrop == 'static' ? a.proxy(this.$element[0].focus, this.$element[0]) : a.proxy(this.hide, this)
						),
					...
					(c = this.$body
						...
						.map(function () {
							var c = a(this),
								...
								e = /^#\w/.test(d) && a(d)
							return (
								(e && e.length && [[e.position().top + (!a.isWindow(b.$scrollElement.get(0)) && b.$scrollElement.scrollTop()), d]]) ||
								null
							)
						})
						.sort(function (a, b) {
		...
		b.prototype = {
			...
			applyPlacement: function (a, b) {
				...
				c.offset(a).addClass(b).addClass('in'),
					...
					b == 'bottom' || b == 'top'
						? ((h = 0),
						  a.left < 0 && ((h = a.left * -2), (a.left = 0), c.offset(a), (f = c[0].offsetWidth), (g = c[0].offsetHeight)),
			...
			hide: function () {
				...
				return (
					c.removeClass('in'), a.support.transition && this.$tip.hasClass('fade') ? e() : c.detach(), this.$element.trigger('hidden'), this
				)
			},
			fixTitle: function () {
				var a = this.$element
			...
			getPosition: function () {
				...
				return a.extend(
					{},
					typeof b.getBoundingClientRect == 'function' ? b.getBoundingClientRect() : { width: b.offsetWidth, height: b.offsetHeight },
					this.$element.offset()
				)
			},
			getTitle: function () {
