...
const jointIter = <P extends Attributes>(aProps: P, bProps: P, callback: (name: string, a: any, b: any) => void) => {
...
export const updateElement = <P extends Attributes>(dom: DOM, aProps: P, bProps: P) => {
