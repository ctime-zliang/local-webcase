import { Attributes, FC, IFiber, Ref, PropsWithChildren } from './src/type'

type _JSX = <P extends Attributes = {}>(type: FC<P>, attrs: P) => Partial<IFiber>

export const jsx: _JSX
export const jsxs: _JSX
export function Fragment(props: any): any

// copy of https://github.com/preactjs/preact/blob/master/src/jsx.d.ts
export namespace JSX {
	interface RefAttribute<T> {
		ref?: Ref<T>
	}
	...
	export type DOMCSSProperties = {
		[key in keyof Omit<CSSStyleDeclaration, 'item' | 'setProperty' | 'removeProperty' | 'getPropertyValue' | 'getPropertyPriority'>]?:
			| string
			| number
			| null
			| undefined
	...
	export interface DOMAttributes<Target extends EventTarget> extends PropsWithChildren {
		// Image Events
	...
	export interface HTMLAttributes<RefType extends EventTarget = EventTarget> extends RefAttribute<RefType>, DOMAttributes<RefType> {
