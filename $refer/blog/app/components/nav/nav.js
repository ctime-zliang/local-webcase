...
let Nav = class Nav extends React.Component {
	...
	render() {
		...
		return React.createElement(office_ui_fabric_react_1.Nav, {
			className: Style.NAV,
			groups: nav_config_1.groups,
			selectedKey: pathname,
			onLinkClick: this.linkClick,
		})
	}
}
Nav = __decorate([ractor_react_1.Providers([HistoryStore_1.HistoryStore])], Nav)
exports.default = Nav
