...
class Messages extends React.Component {
	...
	render() {
		return React.createElement(
			...
			!!this.props.messages.length &&
				React.createElement(react_iscroller_1.InfiniteScroller, {
					...
					onEnd: () => system_1.system.dispatch(new slack_1.NextPage()),
	...
	renderCell(message, index) {
		...
		return React.createElement(
			'li',
			{ key: message.ts, className: Style.LIST_ITEM },
			React.createElement('img', { className: Style.LIST_AVATAR, src: userinfo.profile.image_48 }),
			React.createElement(
				'div',
				{ className: Style.LIST_CONTENT },
				React.createElement('header', null, userinfo.name, ' ', index),
